    ...
    return (
        <Footer>
            <Footer.Wrapper>
                <Footer.Row>
                    <Footer.Column>
                        <Link to="/"><img src={img} alt="upward" style={{ height: "150px", width: "150px" }} /></Link>
                        <Link className="footer-link terms" to="privacy-policy">Privacy Policy</Link>
                        <Link className="footer-link terms" to="terms-and-conditions">Terms and Conditions</Link>
                    </Footer.Column>
                    <Footer.Column>
                        <Footer.Title>About Us</Footer.Title>
                        <Link className="footer-link" to="about">Overview</Link>
                    ...
                    <Footer.Column>
                        ...
                        <Link className="footer-link" style={{color: "white", textDecoration: "none", fontFamily: "'Quicksand', sans-serif", fontSize: 14, marginBottom: 5 }} to="sponsor">Sponsor Us</Link>
                    </Footer.Column>
                    <Footer.Column>
